...
namespace LazyCoder.Haptic
{
    ...
    /// </summary>
    public static class HapticAndroid
    {
        ...
        public static void Init()
        {
            ...
            LDebug.Log(typeof(HapticAndroid), $"Initialized" +
        ...
        public static void Vibrate(HapticType type)
        {
            switch (type)
            {
                ...
                default:
                    LDebug.Log(typeof(HapticAndroid), $"Undefined vibration type {type}");
                    break;
            }
        }
        ...
        public static void Vibrate(long[] pattern, int[] amplitudes = null, int repeat = -1, bool cancel = false)
        {
            ...
            {
                LDebug.LogWarning(typeof(HapticAndroid), "Length of Amplitudes array is not equal to Pattern array. Amplitudes will be ignored.");
